...
fp_res = FlashPy.where(fp_mat1 > fp_mat2, fp_mat1, fp_mat2)
verify(fp_res, np_res)
...
fp_res = FlashPy.average(fp_mat1, weights=fp_weights)
...
fp_weights = FlashPy.array(np_weights, dtype="l")
np_weights = np.array(fp_weights, copy=True)
fp_res = FlashPy.average(fp_mat1, axis=1, weights=fp_weights, returned=True)
