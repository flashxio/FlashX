...
CXXFLAGS = -g -Wall -DSTATISTICS -DENABLE_AIO -DNUM_NODES=1 #-DPROFILER
...
CC = g++
OBJECTS = part_global_cached_private.o cuckoo_cache.o associative_cache.o workload.o global_cached_private.o direct_private.o read_private.o rand_buf.o memory_manager.o wpaio.o rand-read.o
