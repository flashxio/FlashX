...
kmeans_thread::kmeans_thread(const int node_id, const unsigned thd_id, const unsigned start_rid,
        ...
        const std::string fn) : base_kmeans_thread(node_id, thd_id, ncol,
            ...
            local_clusters = km::clusters::create(g_clusters->get_nclust(), ncol);
