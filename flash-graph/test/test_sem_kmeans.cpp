...
void test_cluster() {
    ...
    for (size_t cl = 0; cl < k; cl++) {
        ...
        g_clusters[cl]->set_prev_dist(eucl_dist(&(g_clusters[cl]->get_mean()),
    ...
    std::cout << "\n\n Members in 2 = " << g_clusters[2]->get_num_members() << std::endl;
    std::cout << "\n\n Members in 1 = " << g_clusters[1]->get_num_members() << std::endl;
    exit(-1);
