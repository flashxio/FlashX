...
namespace {
    ...
    static clustercore::clusters::ptr g_clusters; // cluster means/centers
    ...
    namespace fg
    {
        void compute_sem_kmeans(FG_graph::ptr fg,
                ...
                clustercore::cluster_t& ret, const unsigned num_rows,
            ...
            g_clusters = clustercore::clusters::create(K, NUM_COLS);
            if (centers)
