...
namespace {
uint64_t m; // 1/2 the sum of all in and out edges

class louvain_vertex: public compute_vertex
{
	float k; // vertex edge sum of in & out edges
	vertex_id_t c; // current cluster
	int delta; // This is per cluster but can be treated as per vertex if we rebuild graph
	// TODO: Add more
